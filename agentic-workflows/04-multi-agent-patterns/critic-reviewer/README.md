...
These questions are here to make **Critic / Reviewer** feel like an agent-design decision instead of a vocabulary word. The useful question is not just "what is it?" but "what failure, control problem, or reliability concern does it help me handle?"
...
**Question:** Is that a warning sign that the team may be using **Critic / Reviewer** as ceremony rather than engineering?
