...
> **Working folder:** `progress/2026-05-01/working-folder/<subject>/` (scaffolded; gitignored)
...
**Save to:** `progress/2026-05-01/working-folder/agentic-workflows/TinyAgent.cs` (gitignored — your scratch).
