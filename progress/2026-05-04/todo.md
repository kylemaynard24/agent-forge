...
> **Working folder:** `progress/2026-05-04/working-folder/<subject>/` (scaffolded; gitignored)

> **Carried forward from 2026-05-01.** Both items below were assigned in the 2026-05-01 round 1 slice and never marked complete. Re-listed here so today's slice picks them up cleanly. The 2026-05-01 todo is preserved for history; work the items here.
...
**Save to:** `progress/2026-05-04/working-folder/agentic-workflows/TinyAgent.cs` (gitignored — your scratch).
