...
- [~] **S-01** — (~30 min) Read `agentic-workflows/01-foundations/what-is-an-agent/README.md` (252 lines). Capture 3–5 takeaways. See sprint section "Agentic workflows". (assigned 2026-05-01 round 1; carried forward to 2026-05-04, again to 2026-05-05)
